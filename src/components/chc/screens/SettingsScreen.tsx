...
const SETTINGS_LABELS = {
  ...
  displayComments: { english: 'Display Comments', arabic: 'عرض التعليقات' }, displaySilentPrayers: { english: 'Display Silent Prayers', arabic: 'عرض الصلوات السرية' },
...
export default function SettingsScreen({ onClose }: SettingsScreenProps) {
  ...
  const { preferences, toggleLanguage, setFontScale, setFontScaleValue, setOrientationMode, toggleSelectText, toggleSlideshowMode, toggleDisplayComments, toggleDisplaySilentPrayers, toggleSaintHymn, clearSaintHymns, toggleInMonastery } = useReadingPreferences();
