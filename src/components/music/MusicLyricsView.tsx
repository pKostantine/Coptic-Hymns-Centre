...
const styles = StyleSheet.create({
  ...
  lineText: { color: COLORS.muted, fontFamily: TYPOGRAPHY.body, fontSize: 18, lineHeight: 27, fontWeight: '600', opacity: 0.55 },
  lineTextFullscreen: { fontSize: 32, lineHeight: 46, textAlign: 'center', opacity: 0.38 },
  lineTextActive: { color: COLORS.white, opacity: 1 },
  lineTextActiveFullscreen: { fontSize: 38, lineHeight: 52 },
